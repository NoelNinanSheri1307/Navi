...
const LOCAL_FALLBACK_BENCHMARKS = [
  {
    "algorithm": "GA",
    "fitness": -0.17120772,
    "avg_wait_time": 2787.5483,
    "avg_queue_length": 100.6749,
    "total_flow": 1503.5225,
    "convergence_history": [
      -0.17208872, -0.17182792, -0.17182792, -0.17084415, -0.17084415,
      -0.17084415, -0.17084415, -0.16671971, -0.16671971, -0.16671971,
      -0.16671971, -0.16671971, -0.16671971, -0.16671971, -0.16671971,
      -0.16671971, -0.16491507, -0.16491507, -0.16491507, -0.16314338
    ]
  },
  {
    "algorithm": "PSO",
    "fitness": -0.18015985,
    "avg_wait_time": 2781.5293,
    "avg_queue_length": 100.1111,
    "total_flow": 1496.2287,
    "convergence_history": [
      -0.16990863, -0.16990863, -0.16990863, -0.16522664, -0.16522664,
      -0.16522664, -0.16522664, -0.16522664, -0.16503316, -0.16370934,
      -0.16370934, -0.15745721, -0.15745721, -0.15745721, -0.15745721,
      -0.15745721, -0.15745721, -0.15745721, -0.15745721, -0.15745721
    ]
  },
  {
    "algorithm": "GWO",
    "fitness": -0.1906521,
    "avg_wait_time": 3409.7212,
    "avg_queue_length": 99.4592,
    "total_flow": 1510.4994,
    "convergence_history": [
      -0.15881171, -0.15881171, -0.15881171, -0.15881171, -0.15881171,
      -0.15881171, -0.15881171, -0.15881171, -0.15881171, -0.15881171,
      -0.15881171, -0.15881171, -0.15881171, -0.15881171, -0.15881171,
      -0.15881171, -0.15881171, -0.15881171, -0.15881171, -0.15881171
    ]
  },
  {
    "algorithm": "DE",
    "fitness": -0.17546683,
    "avg_wait_time": 3212.4995,
    "avg_queue_length": 98.6764,
    "total_flow": 1547.1506,
    "convergence_history": [
      -0.16921216, -0.16192411, -0.16192411, -0.15631366, -0.15631366,
      -0.15631366, -0.15631366, -0.15631366, -0.15631366, -0.15631366,
      -0.15631366, -0.15631366, -0.15631366, -0.15631366, -0.15631366,
      -0.15631366, -0.15631366, -0.15631366, -0.15631366, -0.15631366
    ]
  },
  {
    "algorithm": "ACO",
    "fitness": -0.16956919,
    "avg_wait_time": 2323.7503,
    "avg_queue_length": 100.9482,
    "total_flow": 1493.1795,
    "convergence_history": [
      -0.16851937, -0.16449099, -0.16427008, -0.16427008, -0.16333582,
      -0.16333582, -0.16333582, -0.16333582, -0.16266139, -0.16266139,
      -0.16266139, -0.16266139, -0.16266139, -0.16266139, -0.16266139,
      -0.15917814, -0.15917814, -0.15917814, -0.15917814, -0.15917814
    ]
  },
  {
    "algorithm": "SA",
    "fitness": -0.1780113,
    "avg_wait_time": 3046.4894,
    "avg_queue_length": 101.317,
    "total_flow": 1486.5831,
    "convergence_history": [
      -0.1785961, -0.1785961, -0.1785961, -0.1785961, -0.16786481,
      -0.16786481, -0.16786481, -0.16786481, -0.16688649, -0.16688649,
      -0.16688649, -0.16688649, -0.16688649, -0.16675628, -0.16675628,
      -0.16675628, -0.16436467, -0.16436467, -0.16414077, -0.1596539
    ]
  },
  {
    "algorithm": "ASM",
    "fitness": -0.18137095,
    "avg_wait_time": 3255.9083,
    "avg_queue_length": 100.9913,
    "total_flow": 1487.632,
    "convergence_history": [
      -0.17483104, -0.16851097, -0.16851097, -0.16851097, -0.16648306,
      -0.16346753, -0.16346753, -0.16346753, -0.16346753, -0.16326935,
      -0.16326935, -0.16326935, -0.16326935, -0.16326935, -0.16326935,
      -0.16326935, -0.16326935, -0.16326935, -0.16326935, -0.16326935
    ]
  }
];
...
export const BenchmarkCenter = () => {
  const [rawData, setRawData] = useState(LOCAL_FALLBACK_BENCHMARKS);
  ...
  useEffect(() => {
    fetch(`${API_BASE_URL}/benchmark`)
      ...
      .catch(() => {
        // Fallback to local defaults on failure
        setRawData(LOCAL_FALLBACK_BENCHMARKS);
        const algos = LOCAL_FALLBACK_BENCHMARKS.map(d => d.algorithm);
        setSelectedAlgos(algos);
        setLoading(false);
      });
  }, []);
